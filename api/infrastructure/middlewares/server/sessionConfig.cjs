...
const sessionConfig = session({
  ...
  cookie: {
    ...
    httpOnly: false, // Permite el acceso a la cookie desde el lado del cliente (puede ser ajustado a true por seguridad)
    maxAge: 60 * 60 * 1000, // Duración de la sesión: 1 hora (en milisegundos)
  },
});
